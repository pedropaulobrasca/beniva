export const Footer = () => {
  return (
    <div className="relative mt-16 w-full text-white bg-deep-purple-accent-400">
      <svg
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-deep-purple-accent-400">
