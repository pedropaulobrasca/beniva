export const Header = () => {
  return (
    <div className="relative bg-deep-purple-accent-400 w-full">
      ...
      <div className="px-4 py-16 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 bg-green-300">
